...
const  WhyChooseHeader = () => {
   return  (
       ...
       <Typography variant='h2'  className='WhyChooseUs-txt' fontSize={{xs: '1.2em', lg: '1.5em'}} >Why choose us?</Typography>
                           <Typography variant='p'  className='WhyChooseUs-txt txt'>A large part of our role is choosing which particular coffees will be featured in our range. This means working 
