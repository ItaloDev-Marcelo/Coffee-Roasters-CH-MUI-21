...
export default function WhyChooseUs() {
    return (
        <Stack component='section' id='WhyChooseUs'>
            <Box id='blockImage-Container'  display={{xs: 'block', sm: 'none'}} sx={{ position: 'relative' }}>
                <img src={Block0} alt='' />
                <WhyChooseHeader/>
                <WhyCard/>
            </Box>

            <Box id='blockImage-Container' display={{xs:'none', sm: 'block', lg: 'none'}} sx={{ position: 'relative' }}>
                <img src={Block1} alt='' />
                <WhyChooseHeader />
                <WhyCard />
            </Box>

            <Box id='blockImage-Container' display={{xs:'none', lg: 'block'}} sx={{ position: 'relative' }}>
                <img src={Block2} alt='' />
                <WhyChooseHeader />
                <WhyCard />
            </Box>
